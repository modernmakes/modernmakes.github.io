...
Printing is straightforward but requires some dialling in. The same additives that cause stringing tendency mean you'll need more retraction than standard PLA. Temperature at the lower end of the range (200–210°C) reduces stringing. Fan at 60–80% handles cooling without hurting the surface finish. Once you have the retraction and temperature tuned, silk PLA prints as reliably as standard PLA and delivers results that get comments from anyone who sees them.
